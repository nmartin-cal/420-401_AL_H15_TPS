...
const int Constants::MaxEnergy = 50;
const int Constants::EatingBonus = MaxEnergy/2;
const int Constants::MovePenalty = 3;
const int Constants::NoMovePenalty = 1;
const int Constants::MaxTurns = 500;
